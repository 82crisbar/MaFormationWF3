...
{
	//htmlentities() permet d'eviter l'ingection de code (sql, css, xss etc...) cette fonction transforme les catachteres tel que <> & ... en entites html, ce la permet d'avoir un code source propre et de bloquer les ingections.
	// Le deuxieme argument ENT_QUOTES permet la prise en charge egalement des " et de '.
	...
	{
		// enregsitrement avec la methode prepare car les informations venant du formulaire peuvent contenir des injections sql
