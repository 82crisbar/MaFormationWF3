...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
						<a href="#" target="_blank" class="btn btn-danger btn-round">Sign In</a>
                    </li>
                    <li class="nav-item">
						<a href="inscription.php" target="" class="btn btn-primary btn-round">Sign Up</a>
					</li>
                </ul>
            </div>
        </div>
    ...
    <div class="wrapper">
        <div class="page-header section-dark" style="background-image: url('assets/img/backgroundMusic.jpg')">
            <div class="filter"></div>
    		<div class="content-center">
    			<div class="container">
    				<div class="title-brand">
    					<h1 class="presentation-title">MUSIC MATCH</h1>
    					<div class="fog-low">
    						<img src="" alt="">
    					</div>
    				...
    				<h2 class="presentation-subtitle text-center">Discover new music based on your favourite bands </h2>
    			</div>
    		</div>
            <div class="moving-clouds" style="background-image: url('assets/img/clouds.png'); ">

            </div>
    		<h6 class="category category-absolute">Designed and coded by US @ WebForce3
    			<a href="#" target="_blank">
    				<img src="assets/img/fog-low.png" class="moving-clouds">
    			</a>
    		</h6>
    	</div>
